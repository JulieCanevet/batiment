...
include '../vue/new_project_vue.php'; // add form to add new project

if (!empty($_POST['construction_name']) && !empty($_POST['project_manager']) && !empty($_POST['description']) && !empty($_POST['start_date']) && !empty($_POST['end_date'])){ // if fields are full
...
// checking the date format
	...
	$create_project = create_project($_POST['construction_name'], $_POST['project_manager'], $_POST['description'], $_POST['start_date'], $_POST['end_date'], $bdd); // inserts datas into the database
